const LOCAL_VERSION='0.17.1';
const RELEASE_ID='0.17.1-cleanup';
const RELEASE_NOTES={
  title:'Beta 0.17.1 – Aufgeräumte Oberfläche',
  date:'21.08.2026',
  notes:[
    ...
    'Nicht funktionierende Seitennavigation und die Demo-Schaltfläche wurden aus der Oberfläche entfernt.',
